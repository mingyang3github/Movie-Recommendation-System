...
public class Normalize {
    ...
    public static class NormalizeReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            // output movieA movieB=normalized_x
            //        movieA movieC=normalized_y

            // record the relation number in a hashmap 
            // and compute the sum 
            int sum = 0;
            ...
            // for each movie, get normalized value
